...
find /home/centos/Vtuber-recorder/ -maxdepth 4    -name "*.ts.log"   -type f -size -35k  -exec ls -l  {} \;
find /home/centos/Vtuber-recorder/ -maxdepth 4    -name "*.ts.log"   -type f -size -35k  -delete  ;