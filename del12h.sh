...
find folder/Vtuber-recorder/log/ -maxdepth 5 -name "screenlog_*.log*"  -type f -exec ls -l {} \; >> "folder/Vtuber-recorder/log/del12h$(date +"[%Y-%m-%d-%H]").log" 2>&1
find folder/Vtuber-recorder/log/ -maxdepth 5 -name "screenlog_*.log*"  -type f -delete; >> "folder/Vtuber-recorder/log/del12h$(date +"[%Y-%m-%d-%H]").log" 2>&1
