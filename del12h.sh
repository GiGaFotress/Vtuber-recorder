find /home/centos/Recorder/savevideo/  -maxdepth 3  -name "*.ts"  -type f -mmin +240 -exec ls -l {} \;
find /home/centos/Recorder/savevideo/  -maxdepth 3  -name "*.ts"   -type f -mmin +240 -exec rm  {} \;
find /home/centos/Recorder/savevideo/  -maxdepth 3  -name "*.ts.*"  -type f -mmin +240 -exec ls -l {} \;
find /home/centos/Recorder/savevideo/  -maxdepth 3  -name "*.ts.*"  -type f -mmin +240 -delete ;
